...
export function MobilidadeDashboardClient({ ctx }: { ctx: any }) {
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, flex: 1 }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: 13, color: "var(--muted)" }}>
            {environments.find(e => e.value === conn.environment)?.label} \u2022 {conn.scopes.length} escopo(s)
          </div>
        </div>
    ...
    <div className="space-y-6">
      ...
      {showForm && (
        <div className="card p-4" style={{ border: "1px solid var(--border)" }}>
          <h3 style={{ marginBottom: 16, fontWeight: 600 }}>{formData.provider_id === "ViaVerde" ? "Nova Liga\u00E7\u00E3o Via Verde" : formData.provider_id === "CTTPortagens" ? "Nova Liga\u00E7\u00E3o CTT Portagens" : "Nova Liga\u00E7\u00E3o IMT"}</h3>
