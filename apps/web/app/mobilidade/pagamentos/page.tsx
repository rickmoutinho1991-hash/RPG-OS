  ...
  return (
    <main className="space-y-6">
      ...
      <p className="text-sm text-muted mb-4">
        Consulte o hist\u00F3rico de pagamentos de portagens.
      </p>
      ...
      <div className="card p-4">
        ...
        <div className="empty-state" style={{ padding: 32, textAlign: "center" }}>
          ...
          <h3 style={{ margin: "0 0 8px" }}>Nenhum pagamento dispon\u00EDvel</h3>
          <p style={{ color: "var(--muted)", margin: 0 }}>
            Configure uma liga\u00E7\u00E3o a um servi\u00E7o de mobilidade para consultar os pagamentos
          </p>
        </div>
      </div>
      ...
      <div className="mt-6 pt-6 border-t">
        <p className="text-xs text-muted">
          O hist\u00F3rico de pagamentos requer onboarding oficial com Via Verde ou CTT Portagens.
